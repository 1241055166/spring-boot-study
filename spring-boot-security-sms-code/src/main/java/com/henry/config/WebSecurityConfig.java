...
import com.henry.filter.ImageCodeFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        //开启登陆配置
        http.apply(smsCodeAuthenticationSecurityConfig).and().addFilterBefore(imageCodeFilter, UsernamePasswordAuthenticationFilter.class).authorizeRequests()
