package com.henry.shiroandjwt.config;


import com.henry.shiroandjwt.filter.JwtFilter;
import com.henry.shiroandjwt.jwt.JwtRealm;
import com.henry.shiroandjwt.jwt.JwtSubjectFactory;
...
//        filterChainDefinitionMap.put("/productInfo/**", "roles[user]");
     ...
     * @author henry
     * @date 2020/11/24
     * @return: com.henry.shiroandjwt.jwt.JwtRealm
     */
    @Bean
