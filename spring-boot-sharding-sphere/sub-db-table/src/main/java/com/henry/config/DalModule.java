 ...
 * @author henry
 * @Description: 连接数据库信息
 * @date 2022/02/03 下午12:31
 */
@Configuration
@ComponentScan(basePackageClasses = DalModule.class)
@MapperScan(basePackages = "com.henry.mapper")
public class DalModule {
    ...
    Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("ds0", com.henry.config.DataSourceUtil.createDataSource("ds0"));
        result.put("ds1", com.henry.config.DataSourceUtil.createDataSource("ds1"));
        return result;
    }
