package com.henry.redislikes.util;
...
//        gc.setOutputDir("C://Users/20102273/Desktop/daima/mybatis-plus/src/main/java");	//生成文件的输出目录
        //得到当前项目的路径
...
//        gc.setEntityName("%sEntity");			//实体命名方式  默认值：null 例如：%sEntity 生成 UserEntity
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/springboot_study?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8&autoReconnect=true");
...
//	        pc.setModuleName(scanner("模块名"));
        //父包路径
        pc.setParent("com.itzyq.redislikes");
