package com.henry.breakpoint.model.result;

import com.henry.breakpoint.exception.IErrorCode;
import com.henry.breakpoint.exception.JsonException;
...
public class Result<T> implements Serializable {
    ...
    public static <T> Result<T> ok() {
        return Result.ok(com.henry.breakpoint.model.result.ResultStatus.SUCCESS);
    }
    ...
    public static <T> Result<T> ok(T data) {
        return Result.of(true,data,
                com.henry.breakpoint.model.result.ResultStatus.SUCCESS.getMessage(), com.henry.breakpoint.model.result.ResultStatus.SUCCESS.getCode());
    }
    ...
    public static <T> Result<T> ok(String message) {
        return Result.of(true, null, message,
                com.henry.breakpoint.model.result.ResultStatus.DEFAULT_SUCCESS_CODE);
    }
    ...
    public static <T> Result<T> fail(T data) {
        return Result.of(false, data, com.henry.breakpoint.model.result.ResultStatus.FAIL.getMessage(), com.henry.breakpoint.model.result.ResultStatus.FAIL.getCode());
    }
    ...
    public static <T> Result<T> fail(String message) {
        return Result.of(false, null, message, com.henry.breakpoint.model.result.ResultStatus.DEFAULT_FAILURE_CODE);
    }
    ...
    public static <T> Result<T> fail() {
        return Result.fail(com.henry.breakpoint.model.result.ResultStatus.FAIL);
    }
     ...
     * 构造一个异常的API返回
     *
     * @param <T> {@link com.henry.breakpoint.exception.BaseException} 的子类
     * @return Result
     */
