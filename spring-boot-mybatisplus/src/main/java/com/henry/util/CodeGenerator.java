...
public class CodeGenerator {
	 ...
	 * 请自定义自己的db url
	 */
	private static String DB_URL = "jdbc:mysql://localhost:3306/imoa_dev?serverTimezone=GMT%2B8&characterEncoding=utf-8";
	 ...
	 */
	private static String PACKAGE_NAME = "com.henry";

	/**
	 * 项目根路径
	 */
	private static String BASE_PATH = System.getProperty("user.dir") + "/spring-boot-mybatisplus/src/main/java/";

	public static void main(String[] args) {
		String[] tables = {"feedback_type_object","zz_admin_log"};
	...
	private static void generateByTables(String tableNames){
		...
		focList.add(new FileOutConfig("/templates/entityVo.java.vm") {
			...
			public String outputFile(TableInfo tableInfo) {
				//return BASE_PATH + PACKAGE_NAME.replaceAll("\\.","\\\\") + "\\"
				//		+ tableInfo.getEntityPath().toLowerCase() +"\\vo" + "\\" + tableInfo.getEntityName() + "Vo" + StringPool.DOT_JAVA;
				return BASE_PATH + PACKAGE_NAME.replaceAll("\\.","/") + "/"
						 + tableInfo.getEntityPath().toLowerCase() +"/vo" + "/" + tableInfo.getEntityName() + "Vo" + StringPool.DOT_JAVA;
			}
		});
