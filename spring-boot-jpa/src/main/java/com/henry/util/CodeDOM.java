...
public class CodeDOM {
    ...
    public static void main(String[] args) {
        String[] tables = {"feedback_type_object"};
    ...
    private CodeDOM(String tableName) {
        ...
        basePath = System.getProperty("user.dir") + "/spring-boot-jpa/src/main/java/" + package_;
    }
    ...
    private List<TableInfo> getTableInfo() {
        ...
        try {
            ...
            ps.setString(2,conn.getCatalog());
            rs = ps.executeQuery();
            while (rs.next()) {
